...
def test_yaml_location_helpers_live_in_helper_module() -> None:
    """YAML path walking helpers should not live in the assets.yaml entrypoint."""
    ...
    assert "def _validate_manual_assets" in config_text
    assert "def _validate_liabilities" in config_text
...
def test_yaml_location_helpers_reexport_from_asset_config() -> None:
