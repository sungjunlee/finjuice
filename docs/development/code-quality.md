...
- `use_case.py`, `use_case_helpers.py`, `inputs.py`, `zip_extraction.py`,
  `zip_extraction_helpers.py`, `zip_policy.py`, `copying.py`, `pipeline.py`, and `rendering.py` isolate
  orchestration, ZIP input helpers, input resolution, archive handling, ZIP password helpers, ZIP
