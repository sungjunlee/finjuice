...
Authoritative table-surface SQL lives in
:mod:`finjuice.pipeline.storage.sqlite.repository_read_sql` and is re-exported
...
from finjuice.pipeline.storage.sqlite.repository_read_sql import (
    _READ_TABLE_SQL_V4 as _READ_TABLE_SQL_V4,
)
from finjuice.pipeline.storage.sqlite.repository_read_sql import (
    _READ_TABLE_SQL_V5 as _READ_TABLE_SQL_V5,
)
from finjuice.pipeline.storage.sqlite.repository_read_sql import (
    _read_table_sql,
)
