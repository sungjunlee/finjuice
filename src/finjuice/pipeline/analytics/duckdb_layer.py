...
:mod:`finjuice.pipeline.analytics.readonly_sql`. Transactions-source view SQL
helpers live in :mod:`finjuice.pipeline.analytics.duckdb_layer_helpers`. Both
clusters are re-exported here so existing callers can keep importing from
this module.
...
from finjuice.pipeline.analytics.duckdb_layer_helpers import (
    _build_transactions_source_sql,
    _is_transfer_expr,  # noqa: F401 — re-exported for existing duckdb_layer imports
    _tags_list_expr,  # noqa: F401 — re-exported for existing duckdb_layer imports
    _transactions_source_projection,  # noqa: F401 — re-exported for existing duckdb_layer imports
    _transfer_group_expr,  # noqa: F401 — re-exported for existing duckdb_layer imports
)
...
class DuckDBAnalytics:
    ...
    def register_transactions_view(self, *, require_transactions: bool = True) -> None:
        ...
        try:
            ...
            source_sql = _build_transactions_source_sql(source_columns)
