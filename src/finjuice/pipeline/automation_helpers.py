...
Owns pending-import preview, tagging-pressure, large-transaction, and next-step
helpers. Public ``collect_automation_signals`` stays in
:mod:`finjuice.pipeline.automation`, which re-exports the public names used by
existing callers.
"""
