...
from finjuice.pipeline.cli.commands.ssot_statement import import_json, statement_evidence
...
ssot_app.command("import-json")(import_json)
ssot_app.command("statement-evidence")(statement_evidence)
