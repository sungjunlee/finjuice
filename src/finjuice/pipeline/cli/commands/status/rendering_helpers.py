"""Main status table helpers for ``finjuice status``.

Owns Rich table construction for directory, schema, import, tagging-rate,
transfer, untagged, and rules rows. Payload assembly and emit/render
orchestration stay in :mod:`finjuice.pipeline.cli.commands.status.rendering`.
"""
