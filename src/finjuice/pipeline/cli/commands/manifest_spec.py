...
MUTATING_COMMANDS = {
    ...
    "ssot assets confirm",
    "ssot reconcile submit",
    "ssot reconcile confirm",
    "ssot reconcile withdraw",
    "ssot intake submit",
    "ssot intake revise",
    "ssot intake withdraw",
    "ssot intake confirm",
    "ssot assets correct",
    ...
    "ssot backup deliver run",
    "ssot backup store init",
    "ssot backup store capture",
    "ssot backup store restore",
    "ssot backup store protect",
    "ssot backup store prune",
    "ssot migrate plan",
    "ssot migrate build",
    "tag",
    "template run",
...
ARTIFACT_COMMANDS = {
    ...
    "ssot backup restore",
    "ssot backup restore-bundle",
    "ssot backup deliver status",
    "ssot backup deliver run",
    "ssot backup store init",
    "ssot backup store capture",
    "ssot backup store list",
    "ssot backup store verify",
    "ssot backup store restore",
    "ssot backup store protect",
    "ssot backup store plan",
    "ssot backup store prune",
    "ssot migrate plan",
    "ssot migrate build",
    "ssot migrate verify",
