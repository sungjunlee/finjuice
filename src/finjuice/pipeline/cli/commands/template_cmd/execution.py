...
Owns template rendering, pivot orchestration, audit events, and the run
use case. Pivot SQL builders live in
:mod:`finjuice.pipeline.cli.commands.template_cmd.execution_helpers` and
are re-exported here so existing callers can keep importing from this
module.
"""
...
from .execution_helpers import (
    ...
    PIVOT_OTHER_BUCKET,
    PIVOT_ROW_AXIS_EXPRESSIONS,  # noqa: F401 — re-exported pivot SQL builder
    PivotAgg,  # noqa: F401 — re-exported pivot SQL builder
    PivotValue,  # noqa: F401 — re-exported pivot SQL builder
    _build_pivot_base_rows_sql,
    _build_pivot_bucket_case,
    _build_pivot_column_projection,
    _build_pivot_months_where,  # noqa: F401 — re-exported pivot SQL builder
    _build_pivot_rank_expr,  # noqa: F401 — re-exported pivot SQL builder
    _discover_pivot_columns,
    _next_month_start,  # noqa: F401 — re-exported pivot SQL builder
