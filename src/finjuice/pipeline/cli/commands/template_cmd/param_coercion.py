...
Month-window parsing helpers live in
:mod:`finjuice.pipeline.cli.commands.template_cmd.param_coercion_helpers`
...
from .param_coercion_helpers import (
    MONTH_PATTERN,  # noqa: F401 — re-exported for existing param_coercion imports
    MONTH_WINDOW_FORMAT,  # noqa: F401 — re-exported for existing param_coercion imports
    _expand_month_range,  # noqa: F401 — re-exported for existing param_coercion imports
    _parse_month_start,
    _parse_month_window,
)
