...
Preservation check helpers live in :mod:`finjuice.pipeline.migrate.ops_verify`
...
from finjuice.pipeline.migrate.ops_verify import (
    _check,
    _locator_coverage,
    _planned_inputs_from_manifest,
