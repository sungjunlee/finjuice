...
Mismatch type/severity classification lives in
:mod:`finjuice.pipeline.tagging.gap_analyzer_helpers` and is re-exported here
...
from finjuice.pipeline.tagging.gap_analyzer_helpers import (
    MISMATCH_SEVERITY_ORDER,
    MISMATCH_TYPE_CATEGORY,
    MISMATCH_TYPE_CONFLICT,
    MISMATCH_TYPE_MULTI_TAG_NOISE,
    MismatchClassification,  # noqa: F401 — re-exported for existing imports
    _category_parts,  # noqa: F401 — re-exported for existing imports
    _mapped_categories_for_tags,  # noqa: F401 — re-exported for existing imports
    classify_mismatch,
)
