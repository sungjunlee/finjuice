"""Mismatch classification helpers for tag/category gap analysis.

Owns mismatch type/severity constants, the
:class:`MismatchClassification` metadata record, and the category-mapping
helpers used to classify tagged-but-mismatched gaps without mutating
transactions or rules. The gap analysis and coverage simulation logic stays
in :mod:`finjuice.pipeline.tagging.gap_analyzer`, which re-exports the names
that existing callers import from that module.
"""
