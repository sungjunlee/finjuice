...
def _append_applied_suggestion_audit(config: Config, rule_name: str) -> None:
    """Append a privacy-safe audit event for an auto-applied suggestion rule."""
    ...
    if apply and yes:
        ...
        for suggestion_idx, suggestion in enumerate(suggestions, start=1):
            ...
            try:
                ...
                _append_applied_suggestion_audit(config, applied_rule.name)
                applied_count += 1
