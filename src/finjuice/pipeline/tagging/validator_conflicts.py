...
the checks that inspect already-loaded
:class:`~finjuice.pipeline.tagging.models.TagRule` objects for duplicate
names, pattern overlaps, priority inversions, and invalid regex. The
per-rule schema orchestrator :func:`_validate_rule` stays in
