...
This module owns merchant-context queries, similarity/clustering, payment-gateway
classification, match-pattern generation, and suggested-rule candidate payloads.
