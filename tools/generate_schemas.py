...
JSON Schema construction helpers live in
:mod:`tools.generate_schemas_helpers` and are re-exported here so existing
...
from .generate_schemas_helpers import (
    SCHEMA_DRAFT,
    JsonSchema,
    array_of,
    command_schema,
    ...
    schema_from_dataclass_type,  # noqa: F401 — re-exported for existing generate_schemas imports
    schema_from_pydantic_model,  # noqa: F401 — re-exported for existing generate_schemas imports
    schema_from_python_annotation,  # noqa: F401 — re-exported for existing generate_schemas imports
...
backup_result_properties: dict[str, JsonSchema] = {
    "absent_optional_count": integer,
    "byte_count": integer,
    "consistency_kind": string,
    "data_schema_version": integer_or_null,
    ...
    "file_count": integer,
    "finjuice_version": string,
    "generation_status": {"enum": ["inactive"], "type": "string"},
    "manifest_digest": string,
    "root_count": integer,
    "schema_version": string,
    "status": {"enum": ["ok", "already_complete"], "type": "string"},
}

backup_create_schema = command_schema(
    "backup_create.schema.json",
    "backup create --json output",
    backup_result_properties,
    [
        "status",
        "schema_version",
        "manifest_digest",
...
backup_verify_schema = command_schema(
...
backup_restore_schema = command_schema(
...
ssot_backup_create_schema = command_schema(
    ...
    "ssot backup create --json output",
    {
        ...
        "status": {"enum": ["complete"], "type": "string"},
        "warnings": array_of(string),
    },
    [
        "activation_binding",
...
ssot_backup_restore_schema = command_schema(
    "ssot_backup_restore.schema.json",
    "ssot backup restore --json output",
    {
        "byte_count": integer,
        "checks": array_of(string),
        "dataset_revision": integer,
        "file_count": integer,
        "generation_status": {"enum": ["inactive"], "type": "string"},
        "manifest_digest": string,
        "source_generation": string,
        "status": {"enum": ["restored"], "type": "string"},
        "verified": boolean,
        "warnings": array_of(string),
    },
    [
...
ssot_backup_status_schema = command_schema(
    ...
    "ssot backup status --json output",
    {
        ...
        "complete": boolean,
        "file_count": integer,
        "manifest_digest": string_or_null,
        "reason": string,
        "source_generation": string_or_null,
    },
    [
        "byte_count",
        "complete",
...
SCHEMAS: dict[str, JsonSchema] = {
    ...
    "backup_create.schema.json": backup_create_schema,
    "backup_restore.schema.json": backup_restore_schema,
    "backup_verify.schema.json": backup_verify_schema,
    "ssot_backup_create.schema.json": ssot_backup_create_schema,
    "ssot_backup_restore.schema.json": ssot_backup_restore_schema,
    "ssot_backup_status.schema.json": ssot_backup_status_schema,
